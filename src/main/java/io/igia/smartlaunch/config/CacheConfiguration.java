...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("igiasmartlaunchapp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("igiasmartlaunchapp");
        ...
        config.getMapConfigs().put("io.igia.smartlaunch.domain.*", initializeDomainMapConfig(jHipsterProperties));
