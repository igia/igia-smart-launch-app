...
import io.igia.smartlaunch.domain.Authority;
import io.igia.smartlaunch.domain.User;
import io.igia.smartlaunch.repository.UserRepository;
import io.igia.smartlaunch.security.AuthoritiesConstants;
import io.igia.smartlaunch.service.UserService;
import io.igia.smartlaunch.web.rest.AccountResource;
import io.igia.smartlaunch.web.rest.errors.ExceptionTranslator;
...
public class AccountResourceIntTest{
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@igia.com");
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.email").value("john.doe@igia.com"))
